...
//@interface GStreamerBackendProtocol
//
//@end
...
-(void) run_app_pipeline
{
    ...
    pipeline = gst_parse_launch("rtspsrc location=rtsp://10.0.0.12:8554/camera.rlc_520a_clear protocols=tcp ! rtph264depay ! queue ! h264parse !  avdec_h264 ! autovideosink", &error);
